...
### 1st lecture: cyber security today

From 1980's to cyber security today. 
...
Student presentations. Rest of the lecture we will discuss about the importance of cyber security nowadays. 
- Topics:
...
- Topic:
    - How can company's prepare themselves against the cyber threats?
    - What methods are there to achieve systematic threat modeling? 
- We will discuss some systematic ways to model the threats of the company.
- In this lecture we will also start hands on group work using the Cybermeter tool by Traficom (https://www.kyberturvallisuuskeskus.fi/en/our-services/situation-awareness-and-network-management/kybermittari-cybermeter)
  - Group work: groups are divided into groups of three persons. Group will choose one to be the facilitator, one to be the technical expert, and one to be the business representative. Each person is given a short description of a hypothetical scenario of person's hypothetical role in the company. This will work as a basis for the answers. The group will choose "ACCESS" or "THIRD-PARTIES" topic of the Cyber meter tool (by Traficom):
